    ...
    if ($accion === "crear") {
        ...
        if ($nombre === "") {
            ...
            try {
                ...
                auditoria_registrar($conexion, (int) $_SESSION["id_usuario"], "CREAR", "CURSO", (int) $conexion->lastInsertId(), "Creó el curso \"$nombre\"");
...
$cursos = $conexion->query("SELECT id_curso, nombre FROM cursos WHERE eliminado_en IS NULL ORDER BY nombre")->fetchAll();
