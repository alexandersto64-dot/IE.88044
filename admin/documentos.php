...
<head>
    ...
    <title>Documentos · Panel de Administración - I.E.P. 88044 Abraham Valdelomar</title>
    ...
    <?= csrf_field() ?>
        ...
        <div class="form-row">
            <div class="field">
                ...
                <input type="text" name="titulo" id="titulo" placeholder="Ej. Reglamento Interno 2026" required>
            </div>
            <div class="field">
                <label for="categoria">Categoría</label>
                <input type="text" name="categoria" id="categoria" placeholder="Ej. Normativa" required>
            </div>
        </div>
        <div class="field">
    ...
    <?php else: ?>
        <div class="table-wrap">
            <table class="data-table">
                <thead>
                    <tr><th>Título</th><th>Categoría</th><th>Enlace</th><th>Registrado por</th><th>Fecha</th><th>Acciones</th></tr>
                </thead>
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?= csrf_field() ?>
                                    ...
                                    <input type="hidden" name="id_documento" value="<?= (int)$d['id_documento'] ?>">
